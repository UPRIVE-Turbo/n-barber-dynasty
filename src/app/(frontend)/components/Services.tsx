      ...
      <div className="mx-auto max-w-[1400px] px-4 md:px-12">
        <div className="mb-16 flex flex-col justify-between md:mb-24 md:flex-row md:items-end">
          <div className="max-w-2xl">
            <Reveal as="h2" className="mb-4 text-xs font-bold tracking-[0.2em] text-copper">
              {content.eyebrow}
            </Reveal>
          ...
          <Reveal as="p" delay={200} className="mt-6 max-w-sm border-l-2 border-copper py-2 pl-6 font-light text-dark-gray/70 md:mt-0">
            {content.description}
          </Reveal>
        </div>
          ...
          {services.map((service, i) => (
            ...
            >
              <div className="mb-2 flex items-baseline justify-between">
                ...
                <span className="font-heading text-2xl text-copper transition-transform duration-300 group-hover:scale-110">
                  {service.price}
                </span>
              </div>
              {service.description && (
